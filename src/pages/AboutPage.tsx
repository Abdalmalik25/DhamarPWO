...
export default function AboutPage() {
  ...
  const [activeTab, setActiveTab] = useState<'identity' | 'team' | 'achievements' | 'services'>(
    'identity',
  );
  ...
  const stats = useMemo(
    () => [
      {
        label: 'عاماً من الخدمة المؤسسية',
        value: '45',
        icon: Calendar,
        color: 'from-gov-600 to-gov-700',
      },
      ...
      {
        label: 'رخصة بناء سنوياً',
        value: '2,000+',
        icon: FileText,
        color: 'from-amber-500 to-amber-600',
      },
      {
        label: 'فرعاً ميدانياً',
        value: '12',
        icon: GitBranch,
        color: 'from-purple-500 to-purple-600',
      },
      {
        label: 'خدمة هندسية متكاملة',
        value: '16',
        icon: Compass,
        color: 'from-cyan-500 to-cyan-600',
      },
      {
        label: 'مشروع طرق منفذ',
        value: '283k',
        icon: TrendingUp,
        color: 'from-orange-500 to-orange-600',
      },
      {
        label: 'نشاط تجاري منظم',
        value: '4,245',
        icon: Briefcase,
  ...
  const identity = useMemo(
    () => ({
      mission:
        'مهمتنا تتجاوز الرقابة الهندسية التقليدية، نحن نعمل كشركاء مع المجتمع لتنظيم النهضة العمرانية وتطوير البنية التحتية ونشر الوعي الهندسي. نسعى لحماية حقوق المواطن في بيئة منظمة، وتطبيق المعايير الفنية لضمان استدامة الممتلكات والارتقاء بجودة الحياة بمحافظة ذمار.',
      vision:
        'أن نكون الرواد في صناعة تنمية عمرانية مستدامة، ترتقي بمحافظتنا لتصبح أنموذجاً حضرياً يُحتذى به على مستوى الجمهورية؛ محافظة تتناغم فيها الأصالة والتاريخ مع حداثة التخطيط، وتوفر بيئة آمنة ومزدهرة وصديقة للإنسان.',
      values: [
        {
          name: 'الثقافة الهندسية التوعوية',
          icon: Shield,
          color: 'text-red-600',
          bg: 'bg-red-50',
          border: 'border-red-200',
          desc: 'المواطن هو الشريك الأول، ونشر الوعي الهندسي يسبق الرقابة لضمان بناء مجتمع متكامل',
        },
        {
          name: 'أنسنة المدن',
          icon: HeartHandshake,
          ...
          desc: 'نضع "الإنسان" في قلب المخطط لنصنع بيئة آمنة للمشاة ومساحات خضراء مستدامة',
        },
        {
          name: 'الهوية المعمارية',
          icon: Star,
          color: 'text-amber-600',
          bg: 'bg-amber-50',
          border: 'border-amber-200',
          desc: 'مواءمة الموروث المعماري اليمني مع تقنيات البناء الحديثة للحفاظ على النسيج الحضري',
        },
        {
          name: 'الشفافية والتحول الرقمي',
          icon: Lightbulb,
          color: 'text-purple-600',
          bg: 'bg-purple-50',
          border: 'border-purple-200',
          desc: 'تسهيل الخدمات الهندسية ورقمية الإجراءات لتقديم خدمة حكومية ترقى لتطلعات المجتمع',
        },
        {
          name: 'الاستدامة والمرونة',
          icon: Award,
          color: 'text-gold-600',
          bg: 'bg-gold-50',
          border: 'border-gold-200',
          desc: 'تطبيق معايير هندسية صارمة لضمان مرونة البنية التحتية واستدامتها البيئية',
        },
        {
          name: 'الشراكة المؤسسية',
          icon: Users,
          color: 'text-blue-600',
          bg: 'bg-blue-50',
          border: 'border-blue-200',
          desc: 'نبني شراكات مع اللجان المجتمعية والجهات المعنية لتحقيق المصلحة العامة',
        },
      ],
    }),
    [],
  ...
  const leadership = useMemo(
    () => [
      {
        name: 'م. معاذ عبدالله الشوكاني',
        role: 'مدير عام المكتب',
        phone: '06-425186',
        email: 'moath@pwo-dhamar.gov.ye',
        initial: 'م',
        highlight: true,
      },
      {
        name: 'م. أحمد محمد المنصور',
        role: 'نائب مدير المكتب لشؤون الطرق',
        phone: '',
        email: 'ahmed@pwo-dhamar.gov.ye',
        initial: 'أ',
      },
      {
        name: 'م. عبدالله حسين القاضي',
        role: 'رئيس قسم التراخيص الهندسية',
        phone: '',
        email: 'abdullah@pwo-dhamar.gov.ye',
        initial: 'ع',
      },
      {
        name: 'م. محمد يحيى الحمزي',
        role: 'رئيس قسم الرقابة الفنية',
        phone: '',
        email: 'mohammed@pwo-dhamar.gov.ye',
        initial: 'م',
      },
      {
        name: 'م. علي صالح العنسي',
        role: 'رئيس قسم التخطيط العمراني',
        phone: '',
        email: 'ali@pwo-dhamar.gov.ye',
        initial: 'ع',
      },
      {
        name: 'م. يحيى عبدالملك',
        role: 'مهندس مشاريع أول',
        phone: '',
        email: 'yahya@pwo-dhamar.gov.ye',
        initial: 'ي',
      },
    ],
    [],
  ...
  const achievements = useMemo(
    () => [
      {
        year: '2026',
        title: 'الريادة المؤسسية في تنظيم العمران',
        desc: 'إنجاز 10 وحدات جوار جديدة، وتطوير النظام الإلكتروني المتكامل للتراخيص، وتدريب 45 مهندساً على نظام المعلومات الجغرافي GIS.',
        icon: Award,
      ...
      },
      {
        ...
        desc: 'أتمتة 100% من إجراءات إصدار تراخيص البناء، وربط جميع الإدارات إلكترونياً، وإطلاق منصة المتابعة الذكية للمعاملات.',
        icon: Zap,
        color: 'from-blue-500 to-blue-600',
      },
      {
        year: '2024',
        title: 'توسعة شبكة الخدمات',
        desc: 'افتتاح 3 فروع جديدة في مديريات عتمة، وصبر الموادم، وميفعة عنس. وتطوير مركز خدمة الجمهور بنظام الانتظار الذكي.',
        icon: Handshake,
        color: 'from-emerald-500 to-emerald-600',
      },
      {
        year: '2023',
        title: 'مركز خدمة الجمهور المتطور',
        desc: 'افتتاح المركز الجديد وتقليص زمن إنجاز المعاملة من 14 إلى 5 أيام عمل، ورفع معدل رضا المستفيدين إلى 94%.',
        icon: Compass,
        color: 'from-purple-500 to-purple-600',
      },
      {
        ...
        desc: 'رصف وتأهيل 283,000 م² من شوارع مدينة ذمار، وإنشاء جسر المشاة في التقاطع الغربي، وتطوير شبكة الإنارة العامة.',
        icon: HardHat,
        color: 'from-orange-500 to-orange-600',
      },
      {
        year: '2021',
        title: 'الرقابة الصحية وتعزيز الأمن الغذائي',
        desc: 'تنفيذ 764 زيارة رقابية، وإصدار 911 بطاقة صحية، ومصادرة 812 كجم من المواد غير الصالحة، وضبط 45 مخالفة.',
        icon: Shield,
      ...
      },
      {
        ...
        desc: 'انطلقت مسيرة التحول الرقمي بإطلاق الموقع الرسمي والمنصة الإلكترونية للخدمات، مما مهد الطريق للأتمتة الشاملة.',
        icon: Globe,
        color: 'from-cyan-500 to-cyan-600',
      },
    ],
    ...
    () => [
      {
        ...
        items: [
          'إصدار تراخيص البناء',
          'فحص المخططات الهندسية',
          'الإشراف على التنفيذ',
          'رصد المخالفات العمرانية',
        ],
      },
      {
        ...
        border: 'border-emerald-200',
        items: [
          'تحديث المخططات الحضرية',
          'إنشاء وحدات جوار',
          'تنظيم التوسع السكاني',
          'الحفاظ على المخطط الحضري',
        ],
      },
      {
        name: 'التحول الرقمي',
      ...
      },
      {
        ...
        items: [
          'زيارات رقابية للمنشآت',
          'إصدار البطاقات الصحية',
          'مصادرة المواد غير الصالحة',
          'حماية صحة المستهلك',
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          'إصدار رخص الأنشطة',
          'تجديد التراخيص',
          'ضبط المخالفات التجارية',
          'قاعدة بيانات المكلفين',
        ],
      },
      {
      ...
      },
      {
        ...
        items: ['برامج تدريبية للكادر', 'ورش عمل فنية', 'نقل المعرفة', 'تطوير المهارات الهندسية'],
      },
    ],
    [],
  );
  ...
  const faqs = useMemo(
    () => [
      {
        q: 'ما هي ساعات العمل الرسمية؟',
        a: 'من الساعة 8:00 صباحاً إلى 2:00 ظهراً، من السبت إلى الأربعاء. الخميس والجمعة عطلة رسمية.',
      },
      {
        q: 'كيف يمكنني الحصول على رخصة بناء؟',
        a: 'يتم تقديم طلب عبر مركز خدمة الجمهور مرفقاً بالمستندات المطلوبة (صورة الملكية، المخططات الهندسية، شهادة صحية). مدة المعالجة 5-7 أيام عمل.',
      },
      {
        q: 'ما هي رسوم إصدار رخصة البناء؟',
        a: 'تحدد الرسوم حسب مساحة البناء والنشاط وفقاً للائحة الرسوم المعتمدة من السلطة المحلية. يمكنكم الاستفسار عبر مركز خدمة الجمهور.',
      },
      {
        q: 'هل يمكن متابعة معاملتي إلكترونياً؟',
        a: 'نعم، من خلال منصة الخدمات الإلكترونية على الموقع الرسمي، يمكنكم إدخال رقم المعاملة ومتابعة حالتها خطوة بخطوة.',
      },
      {
        q: 'ما هي الاشتراطات الفنية للبناء في ذمار؟',
        a: 'يجب الالتزام بكود البناء اليمني، والارتدادات النظامية، والمسافات البينية للجيران، وتوفير مواقف السيارات ضمن المخطط.',
      },
      {
        q: 'كيف أبلغ عن مخالفة بناء؟',
        a: 'يمكنكم الإبلاغ عبر مركز خدمة الجمهور هاتفياً 06-425186 أو عبر نموذج التواصل الإلكتروني في الموقع، ويتم التعامل مع البلاغ بسرية تامة.',
      },
    ],
    [],
  );
  ...
  const performanceIndicators = useMemo(
    () => [
      {
        indicator: 'مخططات عمرانية منجزة',
        value: '152 مخططاً',
        details: '125 بمدينة ذمار، 25 بجهران، 2 بالحداء',
      },
      ...
      {
        indicator: 'نسبة إنجاز المعاملات',
        value: '94%',
        details: 'خلال 5 أيام عمل من تاريخ التقديم',
      },
      { indicator: 'مشاريع الطرق المنجزة', value: '283,000 م²', details: 'رصف وصيانة وتأهيل' },
      {
        indicator: 'الزيارات الرقابية السنوية',
        value: '764',
        details: 'للمنشآت التجارية والغذائية',
      },
      ...
      <div className="relative bg-gradient-to-l from-gov-950 via-gov-900 to-gov-950 text-white pt-10 pb-24 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          <button
            ...
            className="mb-4 flex items-center gap-2 text-gold-400 hover:text-gold-300 transition-colors group"
          >
            <ChevronLeft
              size={18}
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center gap-6">
            ...
            <div className="flex-1">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black mb-3 leading-tight text-white drop-shadow-lg">
                من نحن
              </h1>
              <p className="text-white text-base md:text-lg max-w-3xl leading-relaxed drop-shadow-md font-medium">
                نبض الهوية المؤسسية ورحلة العطاء الهندسي لمنظومتنا في قلب محافظة ذمار -{' '}
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {stats.map((stat, i) => {
                ...
                return (
                  <div
                    key={i}
                    className="text-center p-4 rounded-2xl hover:bg-gray-50 transition-all hover:scale-105 group"
                  >
                    <div
                      className={`w-14 h-14 bg-gradient-to-br ${stat.color} rounded-2xl flex items-center justify-center mx-auto mb-3 shadow-lg group-hover:shadow-xl group-hover:scale-110 transition-all`}
                    >
                      <Icon
                        size={24}
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 sm:p-8 md:p-10">
                  <div className="max-w-3xl">
                    ...
                    <p className="text-white/90 text-sm sm:text-base leading-relaxed mb-4">
                      يقع المقر الرئيسي للمؤسسة في قلب مدينة ذمار، حيث يجمع بين الطابع المعماري
                      الحديث والمرافق المتطورة لتقديم أفضل الخدمات للمواطنين.
                    </p>
                ...
                {[
                  ...
                  return (
                    ...
                    >
                      <Icon
                        size={20}
                        className="text-gov-600 mx-auto mb-2"
                      />
            ...
            {[
              {
                icon: Landmark,
                title: 'رسالة راسخة',
                desc: 'نعمل منذ 45 عاماً في تنظيم قطاع التشييد والبناء وإدارة مشاريع البنية التحتية بمحافظة ذمار بكفاءة واقتدار.',
                color: 'from-gov-600 to-gov-700',
              },
              {
                icon: Eye,
                title: 'رؤية استشرافية',
                desc: 'نستشرف المستقبل بخطة تطويرية شاملة تهدف للتحول الرقمي الكامل ورفع جودة الخدمات الحكومية.',
                color: 'from-purple-600 to-purple-700',
              },
              {
                icon: Scale,
                title: 'حوكمة مؤسسية',
                desc: 'نطبق أعلى معايير الحوكمة والشفافية في جميع الإجراءات الإدارية والمالية والفنية.',
                color: 'from-emerald-600 to-emerald-700',
              },
              {
                icon: Network,
                title: 'شبكة فروع متكاملة',
                desc: 'نغطي المحافظة بـ 12 فرعاً ميدانياً تقدم الخدمات الهندسية للمواطنين في مديرياتهم.',
                color: 'from-blue-600 to-blue-700',
              },
            ].map((item) => (
              <div
                key={item.title}
                className="group relative bg-white rounded-2xl border border-gray-200 shadow-sm p-6 hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 overflow-hidden"
              >
                <div
                  className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-5 transition-opacity"
                  style={{
                    backgroundImage: `linear-gradient(to bottom right, ${item.color.split(' ')[0].replace('from-', '')}, ${item.color.split(' ')[1].replace('to-', '')})`,
                  }}
                />
                <div className="relative">
                  <div
                    className={`flex items-center justify-center w-16 h-16 rounded-2xl bg-gradient-to-br ${item.color} text-white mb-4 shadow-lg group-hover:scale-110 group-hover:rotate-3 transition-all`}
                  >
                    <item.icon size={28} />
                  </div>
                  <h3 className="text-lg font-bold text-gray-800 mb-2 group-hover:text-gov-700 transition-colors">
                    {item.title}
                  </h3>
          ...
          <div className="relative bg-gradient-to-br from-gov-50 via-white to-gov-50 rounded-3xl border border-gov-100 p-8 md:p-10 mb-12 overflow-hidden">
            ...
            <div className="relative max-w-5xl mx-auto text-center">
              ...
              <p className="text-gray-600 leading-relaxed text-lg mb-6">
                نمثل المظلة الحكومية الرسمية لقطاع التشييد والبنية التحتية، ونحمل على عاتقنا مسؤولية
                التخطيط الحضري وتطوير المرافق العامة. نعمل بتناغم مع التوجهات التنموية الوطنية،
                لنرسم ملامح مدينة ذكية ومستدامة. يرتكز نجاحنا على نخبة من الخبراء الهندسيين والفنيين
                الذين يتجاوز عددهم <strong className="text-gov-700">320 موظفاً</strong>، يقدمون
                خدماتهم عبر المقر الرئيسي و <strong className="text-gov-700">12 فرعاً</strong>{' '}
                منتشرة في المديريات، لضمان وصول الخدمة باحترافية وسرعة لكل مواطن ومستثمر.
              </p>
                ...
                return (
                  <button
                    ...
                    className={`flex-1 py-4 px-4 flex items-center justify-center gap-2 font-bold text-sm transition-all min-w-fit ${
                      activeTab === tab.id
                        ? 'bg-white text-gov-700 border-b-2 border-gov-600 shadow-sm'
                    ...
                    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
                      {identity.values.map((v, i) => {
                        ...
                        return (
                          <div
                            key={i}
                            className={`${v.bg} rounded-xl p-4 border ${v.border} hover:shadow-md transition-all`}
                          >
                      ...
                      <table className="w-full text-sm">
                        <thead className="bg-gray-50 border-b border-gray-200">
                          <tr>
                            ...
                            <th className="px-6 py-3 text-right font-bold text-gray-600">
                              التفاصيل
                            </th>
                          </tr>
                        </thead>
                        <tbody className="divide-y divide-gray-100">
                          {performanceIndicators.map((item, i) => (
                            ...
                            >
                              ...
                              <td className="px-6 py-3 text-center font-bold text-gov-600">
                                {item.value}
                              </td>
              ...
              {activeTab === 'team' && (
                <div>
                  <p className="text-gray-500 text-sm mb-6 text-center max-w-2xl mx-auto">
                    نخبة من الكفاءات والقيادات الإدارية التي توجه بوصلة العمل نحو آفاق التميز
                    المؤسسي
                  </p>
                  <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {leadership.map((member, i) => (
                      <div
                        key={i}
                        className={`rounded-2xl p-6 text-center border transition-all duration-300 hover:-translate-y-1 hover:shadow-lg ${
                          member.highlight
                      ...
                      >
                        <div
                          className={`w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 text-2xl font-black shadow-lg ${
                            member.highlight
                              ? 'bg-white/20 text-white'
                              : 'bg-gradient-to-br from-gov-600 to-gov-700 text-white'
                          }`}
                        >
                          {member.initial}
                        </div>
                        <h3
                          className={`text-lg font-bold mb-1 ${member.highlight ? 'text-white' : 'text-gray-800'}`}
                        >
                          {member.name}
                        </h3>
                        <p
                          className={`text-sm font-medium mb-4 ${member.highlight ? 'text-gold-300' : 'text-gov-600'}`}
                        >
                          {member.role}
                        </p>
                        <div className="space-y-2">
                          <a
                            href={`tel:+967${member.phone.replace(/-/g, '')}`}
                            className={`text-xs flex items-center justify-center gap-1 transition-colors ${
                              member.highlight
                                ? 'text-white/70 hover:text-white'
                                : 'text-gray-500 hover:text-gov-600'
                            }`}
                          >
                      ...
                      return (
                        ...
                        >
                          <div className="hidden md:flex flex-col items-center">
                            <div
                              className={`w-12 h-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center shadow-lg shrink-0 relative z-10`}
                            >
                              <Icon
                                size={20}
                                className="text-white"
                          ...
                          <div className="flex-1 bg-gradient-to-l from-gray-50 to-transparent rounded-xl p-5 border border-gray-100 hover:shadow-md transition-all">
                            <div className="flex flex-wrap items-center gap-3 mb-2">
                              <span className="text-xs font-bold text-white bg-gov-600 px-2.5 py-1 rounded-full">
                                {item.year}
                              </span>
                          ...
                          {/* أيقونة للجوال */}
                          <div
                            className={`md:hidden w-12 h-12 bg-gradient-to-br ${item.color} rounded-xl flex items-center justify-center shadow-lg shrink-0`}
                          >
                            <Icon
                              size={18}
                              className="text-white"
                  ...
                  <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {services.map((s, i) => {
                      ...
                      return (
                        <div
                          key={i}
                          className={`${s.bg} rounded-xl p-5 border ${s.border} hover:shadow-lg transition-all`}
                        >
                          <div
                            className={`w-12 h-12 ${s.bg} rounded-xl flex items-center justify-center mb-3 border ${s.border}`}
                          >
                            <Icon
                              size={20}
                              className={s.text}
                          ...
                          <ul className="space-y-1.5">
                            {s.items.map((item, j) => (
                              ...
                              >
                                <CheckCircle2
                                  size={12}
                                  className={`${s.text} mt-0.5 shrink-0`}
                                />
                                {item}
                              </li>
                            ))}
          ...
          <div className="relative bg-gradient-to-br from-gov-800 via-gov-900 to-gov-950 rounded-3xl p-8 md:p-10 mb-12 overflow-hidden shadow-2xl">
            ...
            <div className="relative max-w-4xl mx-auto">
              ...
              <div className="space-y-4 text-white/80 leading-relaxed">
                ...
                <p>
                  أرحب بكم في هذه المنصة الرقمية التفاعلية، والتي تمثل نافذتنا نحو المستقبل؛ لترجمة
                  التزامنا الراسخ بتقديم أرقى الخدمات الهندسية وصناعة بيئة عمرانية مستدامة لكل مواطن
                  ومستثمر.
                </p>
                <p>
                  نعمل في المكتب وفق رؤية واضحة تهدف إلى تطوير قطاع التشييد والبناء، وتحسين جودة
                  البنية التحتية، وتعزيز مبادئ الشفافية والحوكمة في جميع إجراءاتنا. وقد قطعنا شوطاً
                  كبيراً في مسيرة التحول الرقمي، ونعمل حالياً على أتمتة شاملية لجميع الخدمات لتسهيل
                  وصول المواطنين إلى الخدمات وتقليص زمن الإنجاز.
                </p>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  ...
                  <ul className="space-y-2 text-white/70">
                    ...
                    <li className="flex items-start gap-3">
                      ...
                      />
                      <span>
                        تطوير الكوادر البشرية والاستثمار في التقنيات الحديثة هو أولوية قصوى
                      </span>
                    </li>
                    <li className="flex items-start gap-3">
                      <ArrowUpRight
              ...
              <div className="mt-6 pt-6 border-t border-white/20 flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-gold-300 text-sm font-medium">
                    مدير عام مكتب الأشغال العامة والطرق – محافظة ذمار
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="bg-white rounded-3xl shadow-lg border border-gray-200 p-6 md:p-8 mb-12">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-500 text-sm mt-2">
                أجوبة على أكثر الأسئلة شيوعاً حول خدمات المكتب
              </p>
            </div>
              ...
              {faqs.map((faq, i) => (
                ...
                >
                  ...
                  >
                    ...
                    <ChevronDown
                      size={16}
                      className={`text-gray-400 transition-transform duration-300 shrink-0 ${openFaq === i ? 'rotate-180' : ''}`}
                    />
                  </button>
                  <div
              ...
              {[
                {
                  ...
                  value: 'شارع الحسينية - جوار مكتب الجمارك',
                  sub: 'H96P+9VX، مدينة ذمار',
                },
                {
                  icon: Phone,
                  title: 'رقم الهاتف',
                  value: INSTITUTIONAL_DATA.phone,
                  sub: 'أيام السبت - الأربعاء 8ص - 2م',
                  href: `tel:+967${INSTITUTIONAL_DATA.phoneCode}`,
                },
                {
                  icon: Mail,
                  title: 'البريد الإلكتروني',
                  value: INSTITUTIONAL_DATA.email,
                ...
                <div
                  key={item.title}
                  className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl hover:bg-gov-50 transition-all"
                >
                  ...
                  <div className="min-w-0">
                    ...
                    {item.href ? (
                      <a
                        href={item.href}
                        className="text-sm font-bold text-gov-600 hover:underline truncate block"
                      >
                        {item.value}
                      </a>
                    ) : (
          ...
          <div className="bg-white rounded-3xl border border-gray-200 shadow-lg overflow-hidden mb-12">
              ...
              <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-2">
                  {[
                    ...
                    {
                      label: 'OpenStreetMap',
                      href: 'https://www.openstreetmap.org/?mlat=14.542930&mlon=44.404580#map=18/14.542930/44.404580',
                    },
                  ].map((link) => (
                    <a
                      key={link.label}
            ...
            <div className="px-6 py-3 bg-gray-50 border-t border-gray-100 flex flex-wrap items-center justify-between gap-2">
              ...
              <p className="text-xs text-gray-500">
                انقر على الخريطة للتفاعل - استخدم التكبير والتصغير
              </p>
            </div>
          </div>
        </ScrollReveal>
